export const FOOTER_LINKS = {
  Resources: [
    ...
    { href: '/bare-acts', label: 'Case Notes' },
    { href: '/blogs', label: 'Legal News' },
  ],
  Community: [
    { href: '/team', label: 'Members' },
    { href: '/join', label: 'Ambassadors' },
    { href: '/join', label: 'Mentorship' },
...
export const INSTAGRAM_INSIGHTS = [
  { title: 'The Future of Artificial Intelligence in Legal Practice', image: '/design-assets/home-insight-01.jpg' },
  { title: 'Constitutional Morality: A Living Concept', image: '/design-assets/home-insight-02.jpg' },
  { title: 'Navigating the Complexities of Corporate Law', image: '/design-assets/home-insight-03.jpg' },
  { title: 'Justice delayed is justice denied.', image: '/design-assets/home-insight-04.jpg' },
];
